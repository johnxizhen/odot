...
describe PasswordResetsController do
  ...
  describe "POST create" do
    context "with a valid user and email" do
      ...
      it "sends a pasword reset email" do
  ...
  describe "PATCH update" do
    context "with no token found" do
      it "renders the edit page" do
        patch :update, id: "not found", user: { password: "1234qwer", password_confirmation: "1234qwer" }
        expect(response).to render_template("edit")
      end
    ...
    context "with a valid token" do
      ...
      it "updates the user's password" do
        ...
        patch :update, id: user.password_reset_token, user: { password: "1234qwer", password_confirmation: "1234qwer" }
        user.reload
